...
{
    public class CombinationRepetition : CombinatoricBaseObject
    {
        /// <summary>
        ...
        public CombinationRepetition(int n, int k) : base(n, k)
        {
        }
        ...
        {
            return Operations.BinomialCoefficient(N + K - 1, K);
        }
